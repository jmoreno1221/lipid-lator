...
public class Sphingolipids_ActivityTest {
    ...
    @Rule
    public ActivityTestRule<Sphingolipids_Activity> mActivityTestRule = new ActivityTestRule<Sphingolipids_Activity>(Sphingolipids_Activity.class);

    private Sphingolipids_Activity mActivity = null;

    Instrumentation.ActivityMonitor monitor = getInstrumentation().addMonitor(Sphingolipids_Result_Activity.class.getName(),null,false);
